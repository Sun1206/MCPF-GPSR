...
def load_datasets(dataset, khop=0):
    # Dataset directory
    data_root = os.environ.get("BINTS_DATA_ROOT", "/datasets")
    ADJ_DIR = os.path.join(data_root, "adj_matrix") + os.sep
    if dataset == "seoul":
        ADJ_FILE = "seoul_adj_matrix_with_diag_1.npy"
        TS_DIR = os.path.join(data_root, "seoul_node_npy_dataset") + os.sep
        OD_DIR = os.path.join(data_root, "seoul_npy_dataset_233_by_233") + os.sep
        ...
        TS_DIR = os.path.join(data_root, "seoul_node_npy_dataset_new") + os.sep
        OD_DIR = os.path.join(data_root, "seoul_npy_dataset_new") + os.sep
        ...
        if dataset == "busan":
            ...
            TS_DIR = os.path.join(data_root, "2022_busan_node_npy_dataset") + os.sep
            OD_DIR = os.path.join(data_root, "2022_busan_npy_dataset_103_by_103") + os.sep
        elif dataset == "busan_new":
            ADJ_FILE = "busan_adj_matrix_with_diag_1_60.npy"
            TS_DIR = os.path.join(data_root, "busan_node_npy_dataset_new") + os.sep
            OD_DIR = os.path.join(data_root, "busan_od_npy_dataset_new") + os.sep
        elif dataset == "daegu":
            ADJ_FILE = "daegu_adj_matrix_with_diag_1.npy"
            TS_DIR = os.path.join(data_root, "2022_daegu_node_npy_dataset") + os.sep
            OD_DIR = os.path.join(data_root, "2022_daegu_npy_dataset_85_by_85") + os.sep
        elif dataset == "daegu_new":
            ADJ_FILE = "daegu_adj_matrix_with_diag_1_61.npy"
            TS_DIR = os.path.join(data_root, "daegu_node_npy_dataset_new") + os.sep
            OD_DIR = os.path.join(data_root, "daegu_od_npy_dataset_new") + os.sep
        elif dataset == "covid":
            ADJ_FILE = "nationwide_adj_matrix_with_diag_1.npy"
            TS_DIR = os.path.join(data_root, "nationwide_node_npy_dataset") + os.sep
            OD_DIR = os.path.join(data_root, "nationwide_npy_dataset") + os.sep
        elif dataset == "nyc":
            ADJ_FILE = "nyc_taxi_matrix_with_diag_1.npy"
            TS_DIR = os.path.join(data_root, "nyc_node_npy_dataset") + os.sep
            OD_DIR = os.path.join(data_root, "nyc_od_npy_dataset") + os.sep
        elif dataset == "nyc_covid":
            ADJ_FILE = "nyc_covid_matrix_with_diag_1.npy"
            TS_DIR = os.path.join(data_root, "nyc_covid_node_npy_dataset") + os.sep
            OD_DIR = os.path.join(data_root, "nyc_covid_od_npy_dataset") + os.sep
